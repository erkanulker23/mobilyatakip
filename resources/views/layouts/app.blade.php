...
<head>
    ...
    <script defer src="{{ route('assets.js', ['file' => 'money.js']) }}"></script>
    <script defer src="{{ route('assets.js', ['file' => 'turkey-address.js']) }}"></script>
    ...
    <style>
        ...
        .table-td strong, .table-td .font-medium { color: #171717; }
        ...
        .dark .table-td .font-medium, .dark .table-td strong { color: #f5f5f5; }
