...
<div class="card p-6 max-w-2xl">
    <dl class="space-y-4">
        ...
        <div><dt class="text-sm text-neutral-500">KDV ({{ number_format($expense->kdvRate, 0) }}%)</dt><dd class="font-medium">{{ number_format($expense->kdvAmount ?? 0, 0, ',', '.') }} ₺ {{ $expense->kdvIncluded ? '(dahil)' : '(hariç)' }}</dd></div>
        @endif
