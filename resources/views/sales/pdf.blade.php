...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .notes { margin-top: 14px; padding-top: 8px; border-top: 1px solid #000; color: #000; }
        ...
        .notice { background: #fff; border-left: 3px solid #000; padding: 8px 10px; margin-bottom: 12px; font-size: 10px; color: #000; font-weight: 600; }
    </style>
</head>
<body>
<div class="header">
