...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #334155; margin: 0; padding: 0; line-height: 1.35; }
        h1 { font-size: 14px; margin: 0 0 2px; color: #0f172a; }
        h2 { font-size: 11px; margin: 0; color: #475569; font-weight: 600; }
        .header { border-bottom: 1px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 10px; }
        .header-table { width: 100%; border-collapse: collapse; }
        .header-table td { vertical-align: top; padding: 0; }
        .doc-no { font-size: 16px; font-weight: bold; color: #047857; line-height: 1.1; }
        .party-row { width: 100%; margin-bottom: 10px; }
        .party-box { width: 48%; display: inline-block; vertical-align: top; }
        .party-label { font-size: 8px; text-transform: uppercase; color: #64748b; font-weight: bold; margin-bottom: 3px; }
        .items { width: 100%; border-collapse: collapse; margin-top: 4px; }
        .items th, .items td { border: 1px solid #e2e8f0; padding: 4px 5px; font-size: 9px; }
        .items th { background: #f8fafc; font-size: 8px; text-transform: uppercase; color: #64748b; }
        .items td.right, .items th.right { text-align: right; }
        .items td.center, .items th.center { text-align: center; }
        .totals { width: 220px; margin-left: auto; margin-top: 8px; }
        .totals table { width: 100%; border-collapse: collapse; }
        .totals td { padding: 2px 0; font-size: 9px; }
        .totals .grand { font-size: 11px; font-weight: bold; border-top: 2px solid #cbd5e1; padding-top: 4px; }
        .notes { margin-top: 10px; padding-top: 6px; border-top: 1px solid #e2e8f0; }
        .muted { color: #64748b; font-size: 9px; margin: 1px 0; }
