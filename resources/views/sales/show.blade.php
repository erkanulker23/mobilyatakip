    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <button type="button"
                ...
                data-track-url="{{ route('tracking.show', $sale->saleNumber) }}"
                onclick="(function(btn){ navigator.clipboard.writeText(btn.dataset.trackUrl).then(function(){ var t = btn.innerHTML; btn.textContent = 'Takip linki kopyalandı'; setTimeout(function(){ btn.innerHTML = t; }, 1800); }); })(this)"
            >
