    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <button type="button"
                ...
                data-track-code="{{ $sale->saleNumber }}"
                title="Takip kodunu kopyala"
                onclick="(function(btn){ navigator.clipboard.writeText(btn.dataset.trackCode).then(function(){ var t = btn.innerHTML; btn.textContent = 'Kopyalandı'; setTimeout(function(){ btn.innerHTML = t; }, 1800); }); })(this)"
            >
                {{ $sale->saleNumber }}
            </button>
            @if(!($sale->isCancelled ?? false))
