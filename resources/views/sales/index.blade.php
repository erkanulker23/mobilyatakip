        ...
        <table class="min-w-full">
            ...
            <tbody>
                ...
                <tr class="border-b border-neutral-50 hover:bg-neutral-50/50 transition-colors {{ ($s->isCancelled ?? false) ? 'opacity-60 bg-slate-50' : '' }}">
                    ...
                    <td class="table-td">@if(!($s->isCancelled ?? false))@include('partials.payment-status-badge', ['status' => $saleStatus])@else—@endif</td>
                    <td class="table-td">
                ...
                <tr>
                    <td colspan="9" class="px-6 py-16 text-center">
                        <div class="max-w-sm mx-auto">
                            ...
                            <p class="mt-4 text-neutral-500 text-sm">Filtreye uygun satış bulunamadı.</p>
