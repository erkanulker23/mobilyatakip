                    ...
                    <div class="sale-form-section-body">
                        ...
                        <div class="grid grid-cols-2 gap-3 mt-4">
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" max="100" name="generalDiscountPercent" id="generalDiscountPercent" value="{{ old('generalDiscountPercent', 0) }}" class="form-input min-h-[44px]" placeholder="0">
                            </div>
                            <div>
                                <label class="form-label" for="generalDiscountAmount">Genel İskonto ₺</label>
                                <input type="text" inputmode="decimal" name="generalDiscountAmount" id="generalDiscountAmount" value="{{ old('generalDiscountAmount') !== null && old('generalDiscountAmount') !== '' ? money(old('generalDiscountAmount')) : '' }}" class="form-input min-h-[44px]" placeholder="0" data-raw="">
                            </div>
                        </div>
                    </div>
                </div>
