    ...
    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="text" inputmode="decimal" name="netPurchasePrice" value="{{ old('netPurchasePrice') !== null && old('netPurchasePrice') !== '' ? money(money_parse(old('netPurchasePrice')), 2) : ($product->netPurchasePrice ? money($product->netPurchasePrice, 2) : '') }}" class="form-input money-input product-price" placeholder="0" autocomplete="off" data-money-decimals="2" data-money-format="blur">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" inputmode="decimal" name="unitPrice" required value="{{ old('unitPrice') !== null && old('unitPrice') !== '' ? money(money_parse(old('unitPrice')), 2) : money($product->unitPrice, 2) }}" class="form-input money-input product-price" placeholder="0" autocomplete="off" data-money-decimals="2" data-money-format="blur">
