...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-900">Müşteri Cari Hesap Özeti</h1>
        <p class="text-slate-600 mt-1">Müşteri bakiyeleri</p>
    </div>
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
    <table class="w-full">
        <thead class="bg-slate-50 border-b border-slate-200">
            <tr>
                <th class="px-6 py-3 text-left text-sm font-semibold text-slate-700">Müşteri</th>
                <th class="px-6 py-3 text-right text-sm font-semibold text-slate-700">Borç (satış)</th>
                <th class="px-6 py-3 text-right text-sm font-semibold text-slate-700">Alacak (tahsilat)</th>
