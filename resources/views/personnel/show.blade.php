...
<div class="mb-6">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
            ...
            <h1 class="text-2xl font-bold text-slate-900">{{ $personnel->name }}</h1>
            <p class="text-slate-600 mt-1">{{ $personnel->title ?? 'Personel detayları' }}</p>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-1">
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <h2 class="text-lg font-semibold text-slate-900 mb-4">İletişim Bilgileri</h2>
            <dl class="space-y-3">
