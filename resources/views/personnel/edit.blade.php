...
<div class="card p-6 max-w-2xl">
    ...
    <form method="POST" action="{{ route('personnel.update', $personnel) }}" enctype="multipart/form-data" class="space-y-5" novalidate>
        ...
        <div>
            ...
            <input type="number" name="commissionRate" value="{{ old('commissionRate', $personnel->commissionRate ?? 0) }}" class="form-input" min="0" max="100" step="0.01" inputmode="decimal" placeholder="Örn: 3">
