...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
    <div>
        ...
        <p class="page-desc">Depo stok durumu</p>
    </div>
        ...
        <table class="min-w-full">
            ...
            <tbody class="divide-y divide-slate-200">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="table-td font-mono text-sm text-slate-600">{{ $s->product?->sku ?? '-' }}</td>
                    ...
                    <td class="table-td text-right font-medium">{{ $s->quantity ?? 0 }}</td>
                    <td class="table-td text-right text-amber-600">{{ $s->reservedQuantity ?? 0 }}</td>
                    <td class="table-td text-right font-medium text-green-600">{{ ($s->quantity ?? 0) - ($s->reservedQuantity ?? 0) }}</td>
                ...
                @empty
                <tr><td colspan="7" class="px-6 py-12 text-center text-neutral-500">Bu depoda stok kaydı yok.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
...
<div class="card p-12 text-center">
    <p class="text-neutral-500">Stok listesini görmek için yukarıdan bir depo seçin.</p>
</div>
@endif
@endsection
