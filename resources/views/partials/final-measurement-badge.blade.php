...
<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-amber-100 text-amber-900 border border-amber-200 {{ $class ?? '' }}" title="Bu sipariş için kesin ölçü alınacak">
