...
<head>
    ...
    <title>Satış Bildirimi: {{ $sale->saleNumber }}</title>
</head>
...
<tr><td style="padding: 24px 32px; border-bottom: 1px solid #e2e8f0;">
    ...
    <p style="margin: 8px 0 0; font-size: 14px; color: #64748b;">Satış bildirimi</p>
</td></tr>
<tr><td style="padding: 24px 32px;">
    <p style="margin:0 0 16px; font-size: 15px;">Sayın <strong>{{ $supplier->name }}</strong>,</p>
    <p style="margin:0 0 20px; font-size: 15px; line-height: 1.5;">Aşağıdaki satış faturası oluşturulmuştur. Sizin tedarik ettiğiniz ürünler bu satışta yer almaktadır.</p>
    ...
    <tr><td style="padding: 12px 16px; font-weight: 600; font-size: 14px;">Genel Toplam</td><td style="padding: 12px 16px; font-size: 14px; font-weight: 600;">{{ number_format($sale->grandTotal ?? 0, 2, ',', '.') }} ₺</td></tr>
    </table>
